...
package com.anupam.rest.generated.processors;
...
/**
 * GetPostsMessageProcessor invokes the {@link com.anupam.rest.RestConnector#getPosts(java.lang.String)} method in {@link RestConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((RestConnector) object).getPosts(_transformedField);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at RestConnector at getPosts retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
