...
/**
 * A <code>RestConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link RestConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-01-10T05:33:56-02:00", comments = "Build UNNAMED.2793.f49b6c7")
public class RestConnectorLifecycleInjectionAdapter
    extends RestConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(RestConnectorLifecycleInjectionAdapter.class);
